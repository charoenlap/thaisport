...
<<<<<<< HEAD
// phpinfo();
	// $Date1 = "2022-04-16 00:00:00";
	// $date = new DateTime($Date1);
 //    $date->add(new DateInterval('P1D')); // P1D means a period of 1 day
 //    $Date2 = $date->format('Y-m-d');
 //    echo $date_expired = $Date2." ".date('H:i:s');
=======
	...
	define('DB_HOST',"gosport_db_1");
	define('DB_USER','root');
	define('DB_PASS',"bybS8Yqq9lJkZMWgKlOYLhhcT");
	define('DB_DB',"goport");

	$db = new db(DB_HOST,DB_USER,DB_PASS);
	$result = $db->query("SELECT * FROM gs_content");
...
>>>>>>> 9e0a66df62fd4cd7f7a4c8396bcdefadc687e7a8
?>