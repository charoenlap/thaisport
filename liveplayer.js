        ...
        r.default)("#" + e.getContainerId())
          , i = {
            "click .op-context-item": function(t, e, A) {
                t.preventDefault(),
                window.open("http://thaisport-stadium.com", "_blank")
            }
        };
        return (0,
